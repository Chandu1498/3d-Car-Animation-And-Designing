...
char name3[]="3D CAR DESIGNING AND ANIMATION";
...
GLvoid Transform(GLfloat Width, GLfloat Height)
{
  ...
  gluPerspective(70.0,Width/Height,0.1,100.0);  /* Calculate The Aspect Ratio Of The Window */
...
void display1(void)
{
	...
	display_string(180,540,"GRAPHICS AND VISUAL COMPUTATION PROJECT",1);
	display_string(215,500,name3,1);
	display_string(250,470,"CHANDRA NEIL BASA(E16CSE084)",2);
	display_string(10,370,"KEYBOARD INSTRUCTIONS",2);
	display_string(10,340,"X-Y-Z KEYS FOR CORRESPONDING AXIS ROTATION",3);
	display_string(10,310,"A-S-Q CAR CUSTOM SIZE SELECTION",3);
	display_string(10,280,"W-E FOR CAMERA VIEW SETTINGS",3);
...
glColor3f(0,0,1);
  glVertex3f(-2,0,1);
  glVertex3f(-2,2,2);         //a green surroundings
  glVertex3f(2,2,2);
  glVertex3f(2,0,1);
...
glColor3f(1,0,1);
  glVertex3f(-1,0,1);
  glVertex3f(-1,2,2);         //a green surroundings
  glVertex3f(1,2,2);
  glVertex3f(1,0,1);
...
glColor3f(0,0,0.9);
  ...
  glVertex3f(-100,2,1);
  glVertex3f(-100,2,100);         //a green surroundings
  glVertex3f(100,2,100);
  glVertex3f(100,2,1);
    glPopMatrix();

int j;
for(i=0;i<2;i+=0.0001)
{

        glColor3f(0,0.4,0.9);
          glVertex3f(-100,0+i,2);
          glVertex3f(-100,0+i,100);         //a green surroundings
          glVertex3f(100,0+i,100);
          glVertex3f(100,0+i,2);
            glPopMatrix();
...
glColor3f(0,0,1);
  glVertex3f(-2+i,0,1);
  glVertex3f(-2+i,2,2);         //a green surroundings
  glVertex3f(2+i,2,2);
  glVertex3f(2+i,0,1);
...
glColor3f(0.7,0.7,0.7);
  glVertex3f(-1+i,0,1);
  glVertex3f(-1+i,2,2);         //a green surroundings
  glVertex3f(1+i,2,2);
  glVertex3f(1+i,0,1);
...
/* Initialisation and window creation */
  ...
  glutCreateWindow("3D CAR DESIGNING AND ANIMATION"); /* Open a window with a title. */
